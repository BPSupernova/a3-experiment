...
function UpsideDownBarChart({ parameters }: { parameters: any }) {
  const tickLength = 6;
  ...
  const renderUpsideDownBars = () => {
    return parameters.data.map((d: any, i: number) => {
      ...
      return (
        <rect
          ...
          strokeWidth={1}     // Optional: set outline thickness
        />
      );
    });
  };
